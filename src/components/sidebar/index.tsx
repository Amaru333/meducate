...
function Sidebar() {
  ...
  return (
    <div className="w-64 h-full flex flex-col">
      <div className="p-6 border-b h-20 flex items-center">Logo</div>
      ...
      <div className="px-6 pb-12">
        <button className={`flex w-full items-center gap-3 px-4 py-3 rounded-full text-red-500 active:scale-95 hover:bg-red-500 hover:bg-opacity-5 transition-all overflow-hidden`}>
